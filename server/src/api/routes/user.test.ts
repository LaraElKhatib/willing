  ...
  test('returns 409 when organization posting ends later today', async () => {
    ...
    await transaction
      ...
      .values({
        ...
        longitude: 35.5,
        max_volunteers: 10,
        start_date: sql<Date>`date(timezone('Asia/Beirut', now()))`,
        start_time: sql<string>`(timezone('Asia/Beirut', now()) - interval '1 hour')::time`,
        end_date: sql<Date>`date(timezone('Asia/Beirut', now()))`,
        end_time: sql<string>`(timezone('Asia/Beirut', now()) + interval '1 hour')::time`,
        minimum_age: 18,
  ...
  test('returns 409 when organization posting ends in the next 5 minutes', async () => {
    ...
    await transaction
      ...
      .values({
        ...
        start_time: sql<string>`(timezone('Asia/Beirut', now()) - interval '1 hour')::time`,
        end_date: sql<Date>`date(timezone('Asia/Beirut', now()))`,
        end_time: sql<string>`(timezone('Asia/Beirut', now()) + interval '5 minutes')::time`,
        minimum_age: 18,
        automatic_acceptance: true,
        is_closed: false,
        allows_partial_attendance: false,
  ...
  test('allows organization deletion when the posting ended earlier today', async () => {
    ...
    await transaction
      ...
      .values({
        ...
        max_volunteers: 10,
        start_date: sql<Date>`date(timezone('Asia/Beirut', now()))`,
        start_time: sql<string>`(timezone('Asia/Beirut', now())::time - interval '2 hours')::time`,
        end_date: sql<Date>`date(timezone('Asia/Beirut', now()))`,
        end_time: sql<string>`(timezone('Asia/Beirut', now())::time - interval '2 minutes')::time`,
        minimum_age: 18,
        automatic_acceptance: true,
        is_closed: false,
        allows_partial_attendance: false,
